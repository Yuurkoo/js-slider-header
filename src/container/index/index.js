class Slider {
  static #content = null // це наш slider__content
  static #left = null
  static #right = null
  ...
  static init = () => {
    ...
    this.#max = this.#content.childElementCount // дізнаємось скільки в нас всього картинок
  ...
  static #slide = (side) => {
    ...
    const scrollWith = this.#content.scrollWith // доступна ширина для прокрутки
    ...
    if (side === 'right') {
      if (
        this.#count === this.#max ||
        scrollLeft === scrollWith - offsetWidth
      ) {
        this.#count = 1
